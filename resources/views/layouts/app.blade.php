...
<head>
    ...
    <title>@yield('title', 'Fancy Store')</title>
</head>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-secondary py-4">
        <div class="container">
            <a class="navbar-brand" href="{{ route('home.index') }}">Fancy Store</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav ms-auto">
                    ...
                    <form id="logout" action="{{ route('logout') }}" method="POST">
                        <a role="button" class="nav-link active" onclick="document.getElementById('logout').submit();">Logout
                        </a> 
                        @csrf
                    </form>
                    @endguest
    ...
    <header class="masthead bg-primary text-white text-center py-4">
        ...
        <div class="container d-flex align-items-center flex-column">
            <h2>@yield('subtitle', 'This is Fancy Store')</h2>
        </div>
    </header>
    <!-- header -->
